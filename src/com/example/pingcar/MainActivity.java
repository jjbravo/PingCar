package com.example.pingcar;
import java.util.ArrayList;
import java.util.Set;

import com.example.pingcar.ConexionBT;
...
public class MainActivity extends ActionBarActivity implements  OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		up =(Button) findViewById(R.id.idup);
		down =(Button) findViewById(R.id.iddown);
		left =(Button) findViewById(R.id.idleft);
		righ =(Button) findViewById(R.id.idrigh);
	...
	builders.setMessage("Comandos de envio:\n" +
			"Al presionar Up envia  'a' en ASCII = 97\n" +
			"Al presionar Down envia 'b' en ASCII = 98\n" +
			"Al presionar Left envia 'c' en ASCII = 99\n" +
			"Al presionar Righ envia 'd' en ASCII = 100\n" +
			"Al presionar Stop envia 'e' en ASCII = 101\n");
	...
	builder.setMessage("Ping Car es una aplicacion basica para uso con la board Pinguino 2550 \nLa aplicacion esta creada con " +
